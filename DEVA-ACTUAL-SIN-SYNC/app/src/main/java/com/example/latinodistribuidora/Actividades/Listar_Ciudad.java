...
public class Listar_Ciudad extends AppCompatActivity {
    ...
    private void sincronizarCiudades(Context context) {
        if (checkNetworkConnection(context)) {
            StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://"+IP+context.getResources().getString(R.string.URL_UPDATE_CIUDADES), new Response.Listener<String>() {
                @Override
