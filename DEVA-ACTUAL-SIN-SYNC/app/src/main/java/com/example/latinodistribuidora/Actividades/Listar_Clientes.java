...
import com.example.latinodistribuidora.Adaptador_Lista_Clientes;
...
public class Listar_Clientes extends AppCompatActivity {
    ...
    private Adaptador_Lista_Clientes adaptadorClientes;
    ...
    public void llenarLista(){
        try{
            ...
            adaptadorClientes = new Adaptador_Lista_Clientes(this,lista);
            ...
            if(cant==0){
                ...
                pie.setText("Más de 2.000 clientes listados".toUpperCase());
            }
            db.close();
    ...
    public void sincronizarClientes(Context context)
    {
        ...
        {
            StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://"+IP+context.getResources().getString(R.string.URL_UPDATE_CLIENTES), response -> {
                ...
                try {
                    ...
                    for(int i = 0; i<array.length(); i++) {
                        ...
                        insertadoClientes = db1.insertarClientesServer(object.getInt("idcliente"), object.getString("razon_social"), object.getString("ruc"),
                                ...
                                object.getString("supermercado"),object.getString("lunes"),object.getString("martes"),object.getString("miercoles"),object.getString("jueves"),
                                object.getString("viernes"),object.getString("sabado"),object.getString("domingo"));
