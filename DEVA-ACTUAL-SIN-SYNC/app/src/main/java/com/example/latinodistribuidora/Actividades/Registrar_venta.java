...
public class Registrar_venta extends AppCompatActivity{
    ...
    private String razonsocial,ruc,fecha,vendedor,idvendedor,establecimiento,puntoexpdicion,facturaA, idEmision, idTimbra, siSuper;
    private TextView txtrazonsocial,txtruc,
            txtfecha, txtvendedor,txtfacturaA,txtoperacion,txtcondicion,txthora, txtsiSuper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtsiSuper = findViewById(R.id.id_si_super);
        ...
        if (extras != null) {
           ...
           // idCliente = extras.getInt("idcliente");
            ...
            siSuper = extras.getString("super");
    ...
    private void AlertaCerrar(){
        ...
        alertDialog.setMessage("¿Seguro que desea cancelar esta venta?");
        alertDialog.setTitle("CANCELAR VENTA");
        alertDialog.setIcon(R.drawable.ic_cancl);
        alertDialog.setCancelable(false);
        alertDialog.setPositiveButton("SI, CANCELAR", new DialogInterface.OnClickListener()
        {
    ...
    private void EnviarDatosaFragmentVenta(){
        Bundle supermercado = new Bundle();
        supermercado.putString("siSuper", siSuper);
        fragment_venta.setArguments(supermercado);
    }
