...
public class ListarUM extends AppCompatActivity {
    ...
    private void sincronizarUM(Context context) {
        if (checkNetworkConnection(context)) {
            StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://"+IP+context.getResources().getString(R.string.URL_UPDATE_UM), new Response.Listener<String>() {
                @Override
