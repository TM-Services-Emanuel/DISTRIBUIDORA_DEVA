        ...
        ((Button)view.findViewById(R.id.btnImprimir)).setOnClickListener(v -> {
            try{
                ...
                if(condicion.equals("CONTADO")){
                    sendData();
                }else if(condicion.equals("CRÉDITO")){
                    sendDataCredito();
                }
...
public void findBT() {
    ...
    public void openBT() throws IOException {
        try {
            ...
            ((ImageButton)vista.findViewById(R.id.btnBT)).setEnabled(false);
        } catch (Exception e) {
            ...
            if (mmSocket != null) {
                ...
                try {
                    ...
                    for(int i=1; i<=lista.size();i++) {
                        ...
                        msg2 += String.format("%1$-9s %2$-12s %3$-14s %4$-10s" , item.ivadescripcion+"%",item.cantidad+" "+item.um, (item.precio), (item.total));
                    }
                    msg2 +="\n";
                    ...
                    String msg7 = "ORIGINAL:  CLIENTE\n";
                    mmOutputStream.write(ESC_ALIGN_LEFT);
                    mmOutputStream.write(0x1C); mmOutputStream.write(0x2E); // Cancelamos el modo de caracteres chino (FS .)
                    mmOutputStream.write(0x1B); mmOutputStream.write(0x74); mmOutputStream.write(0x10); // Seleccionamos los caracteres escape (ESC t n) - n = 16(0x10) para WPC1252
                    mmOutputStream.write(getByteString(msg7,1,0,0,0));
                    String msg8 = "DUPLICADO: ARCHIVO TRIBUTARIO\n";
                    msg8 += "\n";
                    msg8 += "\n";
                    mmOutputStream.write(ESC_ALIGN_LEFT);
                    mmOutputStream.write(0x1C); mmOutputStream.write(0x2E); // Cancelamos el modo de caracteres chino (FS .)
                    mmOutputStream.write(0x1B); mmOutputStream.write(0x74); mmOutputStream.write(0x10); // Seleccionamos los caracteres escape (ESC t n) - n = 16(0x10) para WPC1252
                    mmOutputStream.write(getByteString(msg8,0,0,0,0));
                    String msg9 = empRZ+"\n";
                    ...
                    mmOutputStream.write(0x1C); mmOutputStream.write(0x2E); // Cancelamos el modo de caracteres chino (FS .)
                    mmOutputStream.write(0x1B); mmOutputStream.write(0x74); mmOutputStream.write(0x10); // Seleccionamos los caracteres escape (ESC t n) - n = 16(0x10) para WPC1252
                    mmOutputStream.write(getByteString(msg9,0,0,0,0));
                    mmOutputStream.write("\n\n".getBytes());
        ...
        try {
            if (mmSocket != null) {
                ...
                try {
                    ...
                    msg7 += "\n";
                    msg7 += "\n";
                    msg7 +="RECIBI CONFORME LA MERCADERIA DESCRIPTA EN ESTA\n";
                    msg7 +="FACTURA Y HARE EL PAGO A LA FECHA DE VENCIMIENTO\n";
                    msg7 +="Y EN LAS CONDICIONES ESTIPULADAS EN ESTA FACTURA\n";
                    msg7 += "\n";
                    msg7 += "\n";
                    mmOutputStream.write(ESC_ALIGN_CENTER);
                    mmOutputStream.write(0x1C); mmOutputStream.write(0x2E); // Cancelamos el modo de caracteres chino (FS .)
                    mmOutputStream.write(0x1B); mmOutputStream.write(0x74); mmOutputStream.write(0x10); // Seleccionamos los caracteres escape (ESC t n) - n = 16(0x10) para WPC1252
                    mmOutputStream.write(getByteString(msg7,1,0,0,0));
                    String msg8 ="FIRMA CLIENTE __________________________________\n";
                    msg8 += "\n";
                    msg8 += "\n";
                    msg8 +="ACLARACIÓN    __________________________________\n";
                    msg8 += "\n";
                    mmOutputStream.write(ESC_ALIGN_LEFT);
                    mmOutputStream.write(0x1C); mmOutputStream.write(0x2E); // Cancelamos el modo de caracteres chino (FS .)
                    mmOutputStream.write(0x1B); mmOutputStream.write(0x74); mmOutputStream.write(0x10); // Seleccionamos los caracteres escape (ESC t n) - n = 16(0x10) para WPC1252
                    mmOutputStream.write(getByteString(msg8,0,0,0,0));
                    String msg9 = "ORIGINAL:  CLIENTE\n";
                    mmOutputStream.write(ESC_ALIGN_LEFT);
                    mmOutputStream.write(0x1C); mmOutputStream.write(0x2E); // Cancelamos el modo de caracteres chino (FS .)
                    mmOutputStream.write(0x1B); mmOutputStream.write(0x74); mmOutputStream.write(0x10); // Seleccionamos los caracteres escape (ESC t n) - n = 16(0x10) para WPC1252
                    mmOutputStream.write(getByteString(msg9,1,0,0,0));
                    String msg10 = "DUPLICADO: ARCHIVO TRIBUTARIO\n";
                    msg10 += "\n";
                    mmOutputStream.write(ESC_ALIGN_LEFT);
                    mmOutputStream.write(0x1C); mmOutputStream.write(0x2E); // Cancelamos el modo de caracteres chino (FS .)
                    mmOutputStream.write(0x1B); mmOutputStream.write(0x74); mmOutputStream.write(0x10); // Seleccionamos los caracteres escape (ESC t n) - n = 16(0x10) para WPC1252
                    mmOutputStream.write(getByteString(msg10,0,0,0,0));
                    String msg11 = empRZ+"\n";
                    msg11 += "AGRADECE SU PREFERENCIA";
                    msg11 += "\n\n";
                    mmOutputStream.write(ESC_ALIGN_CENTER);
                    mmOutputStream.write(0x1C); mmOutputStream.write(0x2E); // Cancelamos el modo de caracteres chino (FS .)
                    mmOutputStream.write(0x1B); mmOutputStream.write(0x74); mmOutputStream.write(0x10); // Seleccionamos los caracteres escape (ESC t n) - n = 16(0x10) para WPC1252
                    mmOutputStream.write(getByteString(msg11,0,0,0,0));
                    mmOutputStream.write("\n\n".getBytes());
        ...
        try {
            if (mmSocket != null) {
                try {
                    ...
                    mmOutputStream.write(0x1B); mmOutputStream.write(0x74); mmOutputStream.write(0x10); // Seleccionamos los caracteres escape (ESC t n) - n = 16(0x10) para WPC1252
                    mmOutputStream.write(getByteString(msg6,0,0,0,0));
                    String msg7 = "DUPLICADO: ARCHIVO TRIBUTARIO\n";
                    msg7 += "\n";
                    msg7 += "\n";
                    mmOutputStream.write(ESC_ALIGN_LEFT);
                    mmOutputStream.write(0x1C); mmOutputStream.write(0x2E); // Cancelamos el modo de caracteres chino (FS .)
    ...
    public void sendDataDuplicadoCredito(){
        try {
            if (mmSocket != null) {
                try {
                    //String msg = "\n";
                    ...
                    mmOutputStream.write(getByteString(msg7,1,0,0,0));
                    String msg8="";
                    msg8 +="FIRMA CLIENTE __________________________________\n";
                    msg8 += "\n";
                    msg8 += "\n";
                    msg8 +="ACLARACIÓN    __________________________________\n";
                    msg8 += "\n";
                    ...
                    mmOutputStream.write(0x1B); mmOutputStream.write(0x74); mmOutputStream.write(0x10); // Seleccionamos los caracteres escape (ESC t n) - n = 16(0x10) para WPC1252
                    mmOutputStream.write(getByteString(msg8,0,0,0,0));
                    String msg9 = "DUPLICADO: ARCHIVO TRIBUTARIO\n";
                    msg9 += "\n";
                    mmOutputStream.write(ESC_ALIGN_LEFT);
                    mmOutputStream.write(0x1C); mmOutputStream.write(0x2E); // Cancelamos el modo de caracteres chino (FS .)
                    mmOutputStream.write(0x1B); mmOutputStream.write(0x74); mmOutputStream.write(0x10); // Seleccionamos los caracteres escape (ESC t n) - n = 16(0x10) para WPC1252
