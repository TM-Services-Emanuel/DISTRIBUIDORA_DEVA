...
public class Access_Productos {
    ...
    public long InsertarProductosServer(int idproducto,String cod_interno, String cod_barra, String descripcion, int precio_costo,
                                        int precio_venta, int stock, String estado, int idunidad, int iddivision, int idiva,
                                        String mayorista, int cant_mayorista, int precio_minorista, int precio_supermercado){
        ContentValues values = new ContentValues();
        ...
        values.put("division_iddivision", iddivision);
        values.put("iva_idiva", idiva);
        values.put("mayorista", mayorista);
        values.put("cant_mayorista", cant_mayorista);
        values.put("precio_minorista", precio_minorista);
        values.put("precio_supermercado", precio_supermercado);
