...
public class Ventas extends ArrayList<Ventas> implements Serializable {
    ...
    public String Est, Emision;

    public Ventas(int id, int idemision, int idusuario, String ruc, String descripcion, String nrofactura,
                  String condicion, String fecha, String hora, int total, int exenta, int iva5, int iva10, String estado) {
        this.id = id;
        this.total = total;
        this.exenta = exenta;
        this.iva5 = iva5;
    ...
    public Ventas(int id, int idemision, String Est, String Emision, String nrofactura, String timbrado,
                  ...
                  int idusuario, String nombreusu, String estado) {
        this.id = id;
        this.total = total;
        this.exenta = exenta;
        this.iva5 = iva5;
